...
export declare const colorize: (text: string, color: Color, backgroundColor?: Color) => string;
export declare const severityColor: (severity: DiagnosticSeverity) => Color;
